var sPerguntas = [["JACA", "FRUTA"], ["BANANA", "FRUTA"], ["ABACAXI", "FRUTA"], ["SUZANO", "CIDADE"], ["NEW YORK", "CIDADE"], ["CHAVE DE FENDA", "FERRAMENTA"], ["SERRA TICO-TICO", "FERRAMENTA"], ["MARTELO", "FERRAMENTA"], ["passat", "carro"], ["SAVEIRO", "CARRO"], ["OPALA", "CARRO"], ["ROSA", "FLOR"], ["LÍRIO", "FLOR"], ["VIOLÃO", "INSTRUMENTO MUSICAL"], ["GUITARRA", "INSTRUMENTO MUSICAL"], ["CONTRABAIXO", "INSTRUMENTO MUSICAL"], ["JOHNNY DEPP", "ATOR"], ["WILL SMITH", "ATOR"], ["ILHA DO MEDO", "FILME TERROR"], ["EFEITO BORBOLETA", "FILME TERROR"], ["BATMAN", "PERSONAGENS"], ["DEADPOOL", "PERSONAGEM"], ["CORINGA", "PERSONAGEM"], ["KANEDA", "PERSONAGEM"], ["BLACK", "JOGOS"], ["URBAN CHAOS", "JOGOS"]]
...
function Confere(cLetra) {
    ...
    if (lAchou == false) {
        ...
        document.getElementById("imagem").src = "imagens/forca" + (iErro + 1) + ".gif";
    }
}
...
function acabou(){
    ...
    if(iAcertos == sPalavraSorteada.length){
        ...
        Swal.fire({
            ...
            padding: '3em',
            color: '#fff',
            background: '#fff url("./imagens/error1.gif")',
            showConfirmButton: false,
            backdrop: `
              rgba(34, 34, 34, 0.589);
              left top
