...
function verifica(casa) {
    ...
    if (casas[casa] == 9) {
        ...
        if (vez == 1) {
            ...
            document.getElementById("img" + casa).src = "jogo_da_velha/Felz.png";
            document.getElementById("img" + casa).style.display = 'block'
            //se o jogador da vez for - coloca a boliha
        } else {
            document.getElementById("img" + casa).src = "jogo_da_velha/Nuv.png";
            document.getElementById("img" + casa).style.display = 'block'
        }
